                    ...
                    <ul class="tabs left hide-on-med-and-down">
                        ...
                        <div id="fornecedores" class="col s12">
                            <p class='card-panel red lighten-4'>
                                <a class="modal-trigger waves-effect waves-light btn" href="#novo-forn">Novo</a></p> 
                        </div>
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="col s6 m6 l6">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="" id="nome" type="text" class="validate" name="nome" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <textarea placeholder="" id="descricao" class="materialize-textarea" name="descricao" required></textarea>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="" id="cidade" type="text" name="cidade" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="" id="endereco" type="text" class="validate" name="endereco" required>
                                    ...
                                    <div class="col s6 m6 l6">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input placeholder="" id="bairro" type="text" class="validate" name="bairro">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s5">
                                                <input placeholder="" id="numero" type="number" step="1" min=0 class="validate" value="" name="numero">
                                                <label for="nota-edt">Número</label>
                                            </div>
                                            <div class="input-field col s5">
                                            <p>
                                                <label>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s3">
                                                <input placeholder="" id="ddd" value="" type="text" class="validate" name="ddd">
                                                <label for="ddd">DDD</label>
                                            </div>
                                            <div class="input-field col s9">
                                                <input placeholder="" id="numero-tel" value="" type="text" class="validate" require name="numero-tel">
